...
class Camera {
    ...
    public function __construct(array $input) {
        ...
        $this->_checkRatio();
        $this->_checkWidthAndHeight();
        $this->_initMatrixes();

        $this->__verboseConstruct();
        return $this;
    }

    public function __destruct() {
        $this->__verboseDestruct();
    }

    private function __verboseConstruct() {
        if (Camera::$verbose)
            echo 'Camera instance constructed' . "\n";
    }

    private function __verboseDestruct() {
        if (Camera::$verbose)
    ...
    public function _checkWidthAndHeight() {
